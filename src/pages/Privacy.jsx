      ...
      <main className="flex-grow p-4 md:p-8">
        <div className="max-w-3xl p-8 mx-auto bg-white border border-gray-200 shadow-xl dark:bg-gray-800 dark:border-gray-700 rounded-3xl transition-colors">
          ...
          <div className="space-y-6 leading-relaxed text-gray-700 dark:text-gray-300">
            <section>
              <h2 className="mb-2 text-xl font-semibold text-gray-900 dark:text-white">1. Camera Data</h2>
            ...
            <section>
              <h2 className="mb-2 text-xl font-semibold text-gray-900 dark:text-white">2. Data We Collect</h2>
            ...
            <section>
              <h2 className="mb-2 text-xl font-semibold text-gray-900 dark:text-white">3. Third-Party Services</h2>
