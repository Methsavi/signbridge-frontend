      ...
      <main className="flex-grow p-4 md:p-8">
        <div className="max-w-3xl p-8 mx-auto bg-gray-800 border border-gray-700 shadow-xl rounded-3xl">
          ...
          <div className="space-y-6 leading-relaxed text-gray-300">
            <section>
              <h2 className="mb-2 text-xl font-semibold text-white">1. Use of Service</h2>
            ...
            <section>
              <h2 className="mb-2 text-xl font-semibold text-white">2. AI Accuracy</h2>
            ...
            <section>
              <h2 className="mb-2 text-xl font-semibold text-white">3. Account Responsibility</h2>
